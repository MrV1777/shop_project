        ...
        <form action="{{ route('students.update', $student->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="gender" id="gender"
                    ...
                    <option value="male" {{ old('gender', $student->gender) == 'male' ? 'selected' : '' }}>ຊາຍ</option>
                    <option value="female" {{ old('gender', $student->gender) == 'female' ? 'selected' : '' }}>ຍິງ</option>
                    <option value="other" {{ old('gender', $student->gender) == 'other' ? 'selected' : '' }}>ອື່ນໆ</option>
                </select>
            </div>
